...
#Admin
class TagViewSetAdmin(viewsets.ModelViewSet):
...
# requests.del(`/article/${slug}`),
class ArticlesDestroyAPIView(generics.DestroyAPIView):
    ...
    def destroy(self, request, slug=None):
        try:
            ...
            raise NotFound('A article with this slug does not exist.')
        article.delete()
